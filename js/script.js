...
class Running extends Workout {
  ...
  calcPace() {
    this.pace = (this.duration / this.cadence).toFixed(1);
    return this.pace;
  }
}
...
class Cycling extends Workout {
  ...
  calcSpeed() {
    this.speed = (this.elevationGain / (this.duration / 60)).toFixed(1);
    return this.speed;
  }
}
...
class App {
  ...
  _renderWorkout(workout) {
    ...
    form.insertAdjacentHTML('afterend', html); // Brahamastra
  }

  _renderWorkoutMarker(workout) {
    const popupOption = L.popup({
      maxWidth: 250,
      minWidth: 100,
      autoClose: false,
      closeOnClick: false,
  ...
  _toggleElevationField() {
    /* Closest returns the closest parent with given query selector*/
